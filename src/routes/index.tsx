...
function LiveActivity() {
  ...
  return (
    <div className="fixed bottom-24 right-5 z-30 hidden max-w-xs rounded-2xl border border-border bg-card/95 p-4 shadow-luxury backdrop-blur lg:block">
      <p className="text-[10px] font-semibold uppercase tracking-widest text-cocoa">Live activity</p>
    ...
    <div className="bg-background text-foreground">
      ...
      <section className="py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <Reveal>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Our Services</p>
            </Reveal>
            <Reveal delay={100}>
              ...
              <Reveal key={title} delay={i * 100} variant="up">
                <div className="group h-full rounded-3xl border border-border bg-card p-8 text-center shadow-soft transition duration-500 hover:-translate-y-2 hover:shadow-luxury">
                  <div className="mx-auto grid h-20 w-20 place-items-center rounded-full bg-gradient-to-br from-sand to-cream text-espresso ring-1 ring-border transition group-hover:from-copper/20 group-hover:to-sand">
                    <Icon className="h-8 w-8 text-cocoa" />
                  </div>
            ...
            <div className="overflow-hidden rounded-[2rem] bg-espresso text-cream shadow-luxury lg:rounded-[2.5rem]">
              <div className="grid gap-0 lg:grid-cols-2">
                ...
                <div className="relative bg-cocoa p-8 lg:p-12">
                  ...
                  <img src={whyImg} alt="Adphira team workspace" width={1024} height={1024} loading="lazy" className="relative mx-auto w-full max-w-md drop-shadow-2xl" />
                </div>
              </div>
            </div>
          </Reveal>
      ...
      <section className="py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <Reveal>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Live Dashboard</p>
            </Reveal>
            <Reveal delay={100}>
      ...
      <section className="py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <Reveal><p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Our Process</p></Reveal>
            ...
            {process.map((p, i) => (
              <Reveal key={p.step} delay={i * 120}>
                <div className="relative h-full rounded-3xl border border-border bg-card p-8 shadow-soft transition hover:-translate-y-1 hover:shadow-luxury">
                  <span className="font-display text-5xl font-black text-cocoa/30">{p.step}</span>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-10">
          <Reveal variant="zoom">
            <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-sand via-cream to-sand p-10 text-center shadow-soft sm:p-14 lg:p-20 lg:rounded-[2.5rem]">
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Limited Time</p>
      ...
      <section className="py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
            <div>
              <Reveal><p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Featured Services</p></Reveal>
            ...
            <Reveal delay={200}>
              <Link to="/services" className="text-sm font-semibold text-espresso underline decoration-copper decoration-2 underline-offset-4 hover:text-cocoa">Explore all solutions →</Link>
            </Reveal>
          </div>
            ...
            {featured.map(({ icon: Icon, title, desc }, i) => (
              <Reveal key={title} delay={i * 80}>
                <div className="group h-full rounded-3xl border border-border bg-card p-8 shadow-soft transition hover:-translate-y-1 hover:border-copper/40 hover:shadow-luxury">
                  ...
                  <Link to="/services" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-cocoa">
                    Learn more <ArrowRight className="h-4 w-4" />
                  </Link>
                </div>
              </Reveal>
      ...
      <section className="relative isolate overflow-hidden py-24 lg:py-40">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="max-w-2xl">
            <Reveal><p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Our Vision</p></Reveal>
            <Reveal delay={100}>
              <h2 className="mt-4 font-display text-4xl font-extrabold leading-[1.05] text-cream sm:text-6xl lg:text-7xl">
                Innovating Today,<br />Building <span className="italic text-cocoa">Tomorrow.</span>
              </h2>
            </Reveal>
      ...
      <section className="py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <Reveal><p className="text-xs font-semibold uppercase tracking-[0.3em] text-cocoa">Testimonials</p></Reveal>
