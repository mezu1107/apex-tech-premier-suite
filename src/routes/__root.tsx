...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Adphira LLC — Premium Software, AI & Digital Marketing" },
      { name: "twitter:description", content: "Adphira LLC builds premium websites, mobile apps, AI automation and growth marketing for ambitious businesses worldwide." },
